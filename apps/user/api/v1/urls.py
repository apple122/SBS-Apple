...
from .views import MyObtainTokenPairView, ListUserView, RetrieveUserView, LogoutView, ChangePasswordView, UpdateProfileView, UpdateUserProfileView
...
urlpatterns = [
    ...
    path('api/v1/user/register_staff',
         RegisterStaffView.as_view(), name='auth_register'),
    ...
    #          name='auth_update_profile'),
     path('api/v1/update_user_profile/<int:pk>', UpdateUserProfileView.as_view(), name='update_user_profile'),
